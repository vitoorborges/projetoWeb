...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center w3-black">
  ...
  <a href="#photos" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
	...
	<form class="box" action="ValidarLogin" method="post">
		<h1>Cadastro</h1>
		<input type="text" name="txtLoginCadastro" placeholder="Usuario"> 
		<input type="password" name="txtPasswordCadastro" placeholder="senha"> 
		<input type="hidden" value="2" name="operador">
